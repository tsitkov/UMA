...
public class ConfigurationPropertiesBeanUma {

	private static Logger logger = LoggerFactory.getLogger(ConfigurationPropertiesBeanUma.class);
	...
	public ConfigurationPropertiesBeanUma() {
