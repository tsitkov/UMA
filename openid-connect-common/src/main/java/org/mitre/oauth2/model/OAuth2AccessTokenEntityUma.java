...
@NamedQueries({
	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getAll", query = "select a from OAuth2AccessTokenEntityUma a"),
	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getAllExpiredByDate", query = "select a from OAuth2AccessTokenEntityUma a where a.expiration <= :date"),
	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getByRefreshToken", query = "select a from OAuth2AccessTokenEntityUma a where a.refreshToken = :refreshToken"),
//	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getByClient", query = "select a from OAuth2AccessTokenEntityUma a where a.rsId = :rsId"),
//	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getByAuthentication", query = "select a from OAuth2AccessTokenEntityUma a where a.authenticationHolder.authentication = :authentication"),
//	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getByIdToken", query = "select a from OAuth2AccessTokenEntityUma a where a.idToken = :idToken"),
	@NamedQuery(name = "OAuth2AccessTokenEntityUma.getByTokenValue", query = "select a from OAuth2AccessTokenEntityUma a where a.value = :tokenValue")
})
//@JsonSerialize(using = OAuth2AccessTokenSerializer.class)
//@JsonDeserialize(using = OAuth2AccessTokenDeserializer.class)
public class OAuth2AccessTokenEntityUma implements OAuth2AccessToken {

//	public static String ID_TOKEN_FIELD_NAME = "id_token";

/*
CREATE TABLE IF NOT EXISTS pat_token (
...
*/
	...
	//private ResourceServerDetailsEntityUma rsId;
	private ClientDetailsEntity rsId;

	private AuthenticationHolderEntity authenticationHolder; // the authentication that made this access

	private JWT jwtValue; // JWT-encoded PAT token value

//	private OAuth2AccessTokenEntityUma idToken; // JWT-encoded OpenID Connect IdToken
	...
	/**
	 * Create a new, blank PAT token
	 */
	public OAuth2AccessTokenEntityUma() {
...
*/
	 ...
	 */
	public void setClient(ClientDetailsEntity rsId) {
		this.rsId = rsId;
	}

	/**
	 * Get the string-encoded value of this PAT
	 */
	@Override
	@Basic
...
//	public OAuth2AccessTokenEntityUma getIdToken() {
//		return null;
		//return idToken;
//	}
	 ...
	 */
//	public void setIdToken(OAuth2AccessTokenEntityUma idToken) {
