...
public class ServerConfigurationTestUma {
	...
	public void testServerConfiguration() {
		...
		ServerConfigurationUma sc = new ServerConfigurationUma();
		sc.setIssuer(issuer);
	...
	public void testEqualsObject() {
		...
		ServerConfigurationUma sc1 = new ServerConfigurationUma();
		sc1.setIssuer(issuer);

		ServerConfigurationUma sc2 = new ServerConfigurationUma();
