...
CREATE TABLE IF NOT EXISTS resource_set (
        ...
        rsid VARCHAR(256),
        pat VARCHAR(4096),
        rs_owner_id  VARCHAR(256),
        rs_owner_name  VARCHAR(256),
        server_id  VARCHAR(2028),
        set_id  VARCHAR(256),
        name VARCHAR(2048),
        scope VARCHAR(2048),
...
CREATE TABLE IF NOT EXISTS permissions (
        ...
        set_id  VARCHAR(256),
        scope VARCHAR(2048),
        perm_ticket VARCHAR(2048)
);

CREATE TABLE IF NOT EXISTS resource_set_registered_scope (
        set_id  VARCHAR(256),
        scope VARCHAR(256)
);
