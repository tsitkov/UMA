--
-- Tables for OIDC/UMA Server functionality, HSQL
--
...
CREATE TABLE IF NOT EXISTS resource_set_policy (
--	owner_id BIGINT,
	rss_id BIGINT, 
	policy VARCHAR(256)
);

CREATE TABLE IF NOT EXISTS rs_details (
	id BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY,
...
--	reuse_refresh_tokens BOOLEAN DEFAULT true NOT NULL,
	...
	rs_id VARCHAR(256),
	rs_secret VARCHAR(2048),
	pat_validity_seconds BIGINT,
	refresh_token_validity_seconds BIGINT,
